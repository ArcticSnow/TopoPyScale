...
def fsm2oshd_sim_parallel(simulation_path='./fsm_sim,',
    ...
    Args:
        ...
        fsm_open_nam (str): file pattern of namelist file for open setup. Default = 'fsm_sim/fsm__open*.nam'. If None, then only performs forest simulation
