...
/
  """
    ...
    if cluster_method:
        ...
        df_forest['cluster_total_area'] = fsm_df.elevation.groupby('point_name').count().elevation.values * dx * dy
        df_forest['proportion_with_forest'] = fsm_df.isfor.groupby('point_name').mean().values
