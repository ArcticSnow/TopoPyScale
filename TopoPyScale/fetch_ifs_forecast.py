...
mydate= -1 #  0 = today (default) -1 = yesterday -2 = day before yesterdaz -3 = day before that. Valid values 0-3.
...
print("Duplicate timestamps removed. Cleaned Hindcast and forecast dataset saved as ../climate/PLEV_fc_cat.nc")
...
print("Duplicate timestamps removed. Cleaned Hindcast and forecast dataset saved as ../climate/SURF_fc_cat.nc")
